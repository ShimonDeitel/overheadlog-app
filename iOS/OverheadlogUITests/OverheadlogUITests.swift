...
final class OverheadlogUITests: XCTestCase {
    ...
    func testAddEntryFlow() throws {
        ...
        nameField.tap()
        nameField.typeText("UI Test Bill")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Bill"].waitForExistence(timeout: 2))
    }
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Overheadlog Pro"].waitForExistence(timeout: 2))
    }
